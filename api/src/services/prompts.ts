...
- for lessons whose skeleton has no in-boundary itemRefs (evidenceStatus inferred), produce 1–3 generated assessment exemplars per D1/§7.12 at released-test quality — distractor-quality choice sets for selected-response formats, strictly inside the lesson's assessment boundary — and label each exactly "Generated exemplar — not a released item" in the releasedItems content. Foundational and introductory lessons are not exempt.
