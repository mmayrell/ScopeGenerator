...
- setMeta: the document's own identity — { subject (e.g. "Mathematics"), grade (e.g. "Grade 4"), sourceOrganization (the publishing body as the document names it, e.g. "Common Core State Standards Initiative" or a state education agency), publicationYear (e.g. "2010") }. For publicationYear, search the whole document — title page, copyright/© notices, page footers, edition or adoption dates. If the document nowhere prints a year but the framework's publication year is well-established public knowledge (e.g. Common Core State Standards Mathematics → "2010"), use that. Return '' only when the year is genuinely unknowable.
