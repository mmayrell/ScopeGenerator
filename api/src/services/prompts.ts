...
- 3–10 interactions total, scaled to length (§15.1 — this SUPERSEDES every "3–7" figure in the base playbook, including §1's Hard Rules and the §13 example's budget); never more than 30 seconds of running time without one; NONE during the title card; placement per the §15.1 skeleton (intro 0–1 preskill retrieval · 1 check after the full model, or 1 per chunk of a chunked model · 2–6 We Do micro-checks · 1–2 instant checks in the discrimination pass, which lives inside late We Do / the wrap per §5's Part C mapping · wrap 0–1 instant). The per-segment maxima never justify exceeding the 3–10 total.
- The House Rules Addendum (§15) is BINDING over §4/§8/§9 where they differ: choreograph every pause per §15.1.4; type selection per §15.2; prompts per §15.3; options/answers per §15.4; feedback ladders per §15.5; UI per §15.6.
- Student-facing language (§15.7): read expressions AS WRITTEN in symbol order ("2,352 divided by 42" — the recorded house style; inside algorithm steps the format's step wording still applies). Internal vocabulary NEVER reaches the student — no "start cue", "decision path", "atom", "I Do / We Do", "discrimination", "interaction", "boundary", "ceiling" in any SAY/TEXT line, prompt, or feedback: translate to student terms.
