...
export const seedSets: StandardSet[] = [
  {
    ...
    standardIdPrefix: 'CCSS.MATH.CONTENT',
...
export const seedScope: Scope = {
  ...
  request: { mode: 'course', params: 'Grade 4 (all published domains)', courseName: 'Grade 4 Mathematics', subject: 'Mathematics' },
